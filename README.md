...
| 角色 | 邮箱 | 密码 | 权限 |
|------|------|------|------|
| 超级管理员（江南） | admin@momentcampus.com | pass123 | 全部权限 + 跨校管理 |
| 学校管理员（复旦） | fudan_admin@momentcampus.com | pass123 | 复旦大学管理 |
| 学校管理员（浙大） | zju_admin@momentcampus.com | pass123 | 浙江大学管理 |
| 普通用户（江南） | user1@example.com ~ user10@example.com | pass123 | 江南大学基础功能 |
| 普通用户（复旦） | fudan_user1@example.com ~ fudan_user5@example.com | pass123 | 复旦大学基础功能 |
| 普通用户（浙大） | zju_user1@example.com ~ zju_user5@example.com | pass123 | 浙江大学基础功能 |
