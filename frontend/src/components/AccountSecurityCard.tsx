...
export const AccountSecurityCard: React.FC = () => {
  ...
  return <Card variant="elevated" padding="lg" className="mb-4"><h2 className="font-display font-semibold text-ink mb-3">账号安全</h2><div className="space-y-4">
  ...
  </div>{toast && <Toast message={toast.message} type={toast.type} onClose={() => setToast(null)} />}</Card>;
};
