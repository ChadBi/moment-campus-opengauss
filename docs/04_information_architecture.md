...
| L3 | 7 | 发布成功页、我的发布、我的收藏、我的评论、浏览历史、草稿箱、信息修改建议页面 |
| **总计** | **29** | |
...
| 分类 | 数量 | 页面列表 |
|------|------|----------|
| 用户端 | 29 | 欢迎页、登录页、注册页、校园选择页、首页、发现页、校园地图页、搜索页、搜索结果页、分类详情页、信息详情页、地点详情页、发布信息页、发布预览页、发布成功页、评论列表、消息通知页、专题清单页、专题详情页、个人中心、我的发布、我的收藏、我的评论、浏览历史、草稿箱、其他用户主页、设置页、举报页面、信息修改建议页面 |
...
| 页面 | 可能的入口数量 | 主要入口 |
|------|--------------|----------|
| 信息详情页 | 10+ | 首页、发现、搜索、地图、分类、专题、收藏、历史等 |
