...
> **历史路线图说明（2026-08-07）**：本文包含早期“附近/定位”示例和路线，相关能力已废弃。当前开发顺序以《此刻校园：AI 地点摘要实施方案》和《小程序契约矩阵与重构执行记录》为准。
...
**互动通知（4 条）：**
1. "校园美食家小林 点赞了你的信息'图书馆东侧自习室'"
2. "图书馆常驻民 评论了你的信息：'确实有插座，我天天去'"
3. "篮球少年阿杰 确认了你的信息有效"
4. "考研狗小王 回复了你的评论：'考研加油！'"

**审核通知（2 条）：**
5. "您发布的信息'第二食堂石锅拌饭'已通过审核"
6. "您举报的信息'虚假兼职'已处理，感谢监督"
...
- [x] 手机号业务唯一键、短信验证码注册/登录
- [x] 微信会话 + 阿里云短信验证码绑定手机号自动登录/建号与微信身份保留（手机号授权接口仅保留兼容）
- [x] 教育邮箱独立认证、唯一绑定和手机号短信解绑
- [x] Web/小程序个人中心一次性设置密码
- [x] Mock/阿里云短信 Provider 配置与验证码哈希存储
- [x] 定向后端认证测试、Web 构建、小程序类型/格式/微信开发者工具编译验证
