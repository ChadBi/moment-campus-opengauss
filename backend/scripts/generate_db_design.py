...
TABLES = [
    ...
    },
    {
        ...
        "fields": [
            ...
            ("expire_at", "TIMESTAMP", False, None, True, None, "过期时间"),
            ("activity_start_at", "TIMESTAMP", False, None, True, None, "活动开始时间"),
            ("activity_end_at", "TIMESTAMP", False, None, True, None, "活动结束时间"),
